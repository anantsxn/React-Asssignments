...
import Search from '../../HOC/PLPwithSearch';
import PLPwithsearch from '../../containers/PLP/product';
...
class Product extends Component {
    ...
    render() {
        ...
        console.log(products, 'in render of search')
        let productsOnSearch = [];
        if (products.length > 0) {

            productsOnSearch = Search(PLPwithsearch, products);
        }
        return (
            <div>{productsOnSearch}</div>
        )
    }
}
